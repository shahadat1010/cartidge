    ...
    if(isset($_POST["register"])){
        ...
        if(!empty($email) && !empty($password)){
            if($rowCount > 0){
                ...
                $result = mysqli_query($connect, "INSERT INTO login (first_name, last_name, phone_number, email, password, status) VALUES ('$firstName', '$lastName', '$phoneNumber', '$email', '$password_hash', 0)");
                ...
                if($result){
                    ...
                    $mail->Username='cartidgeveri@gmail.com';
                    $mail->Password='afyoywrklhgsdkul';

                    $mail->setFrom('cartidgeveri@gmail.com', 'OTP Verification');
                    ...
                    <p>With regards,</p>
                    <b>Cartidge Corner</b>
                    https://www.cartridge-corner.com/";
